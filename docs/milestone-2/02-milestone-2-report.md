...
- PR #7 is the **single consolidated PR onto `main`** containing all of Milestone 2 in one merge button — its CI is green at commit `9f5f96c`.

| PR | Branch | Status |
|----|--------|--------|
| [#4](https://github.com/HusseinSelim-1977/Nourhan_Project/pull/4) | `feature/hf-skill-extraction` | open, CI green |
| [#5](https://github.com/HusseinSelim-1977/Nourhan_Project/pull/5) | `feature/hf-match-scoring` | open, CI green |
| [#6](https://github.com/HusseinSelim-1977/Nourhan_Project/pull/6) | `feature/hf-job-summarization` | open, CI green |
| **[#7](https://github.com/HusseinSelim-1977/Nourhan_Project/pull/7)** | `feature/hf-job-summarization` → `main` | **open, CI green — merge this to land Milestone 2 on `main`** |
...
![Skill extraction](/home/ubuntu/m2-screens/01-skills-extracted.png)
...
### 4.2 Match scoring
![Match scoring](/home/ubuntu/m2-screens/02-match-scored.png)
...
### 4.3 Summarization
![Summarization](/home/ubuntu/m2-screens/03-summary-generated.png)
...
— Submitted with PR #7 ready for merge.
